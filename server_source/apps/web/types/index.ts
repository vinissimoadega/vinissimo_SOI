...
export type FinancialChannelRule = {
  id: string;
  channelId: string;
  channelKey: string;
  channelName: string;
...
export type FinancialReceivableItem = {
  id: string;
...
export type FinancialPayableItem = {
  id: string;
...
export type FinancialSettlementBatch = {
  id: string;
...
export type FinancialOverviewResponse = {
  ...
  receivablesDue: FinancialReceivableItem[];
  payablesDue: FinancialPayableItem[];
  ...
  settlementBatches: FinancialSettlementBatch[];
  channelRules: FinancialChannelRule[];
};

export type FinancialReceivablesResponse = {
  items: FinancialReceivableItem[];
  pagination: {
    page: number;
    pageSize: number;
    totalItems: number;
...
export type FinancialSettlementsResponse = {
  items: FinancialSettlementBatch[];
  pagination: {
    page: number;
    pageSize: number;
    totalItems: number;
