  ...
  return (
    <div className="page-shell">
      ...
      <SectionCard
        ...
        subtitle="Corrija o saldo real contado com trilha auditável. Você pode localizar o SKU digitando ou lendo o código de barras pela câmera."
        title="Ajuste de saldo real"
      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-3 text-sm text-black/55 sm:flex-row sm:items-center sm:justify-between">
          <p>
